...
from constants import FONT_SIZE, MAX_X
...
class VideoService:
    ...
    def draw_actors(self, actors):
        ...
        """ 
        for actor in actors:
            if actor.get_text() == "GAME OVER" or "Score" in actor.get_text():
                # draw centered
                self.draw_actor(actor, centered=True)
            else: self.draw_actor(actor)
